...
const VIEW: DesktopSettingsView = {
  ...
  web: {
    ...
    lanCaUrls: ['https://192.168.1.20:43121/.well-known/dsh-desktop-fork-ca.crt'],
  },
}
...
describe('Desktop settings API', () => {
  ...
  it('strictly validates live LAN HTTPS state and public CA URLs', () => {
    ...
    const invalidCaUrls = [
      'http://192.168.1.20:43121/.well-known/dsh-desktop-fork-ca.crt',
      `https://192.168.1.20:43121/.well-known/dsh-desktop-fork-ca.crt?token=${BROWSER_AUTH_TOKEN}`,
      'https://192.168.1.20:43121/ca.crt',
      'https://desktop.local:43121/.well-known/dsh-desktop-fork-ca.crt',
      'https://127.0.0.1:43121/.well-known/dsh-desktop-fork-ca.crt',
    ]
