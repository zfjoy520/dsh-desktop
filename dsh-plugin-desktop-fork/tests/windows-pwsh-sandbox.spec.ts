...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\DSH Desktop Fork\\DSH Desktop Fork.exe',
  upstreamRunner: 'C:\\Program Files\\DSH Desktop Fork\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\DSH Desktop Fork\\resources\\app.asar\\desktop-runner.js',
}
