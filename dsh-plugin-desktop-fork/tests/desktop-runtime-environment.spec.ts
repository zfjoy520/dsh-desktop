...
function temporaryDirectory(): string {
  const directory = mkdtempSync(join(tmpdir(), 'dsh-desktop-fork-pnpm-runtime-'))
...
function options(
  ...
  return {
    ...
    appExecutable: platform === 'win32'
      ? 'C:\\Program Files\\DSH 100% Desktop\\DSH Desktop Fork.exe'
      : "/Applications/DSH O'Brien.app/Contents/MacOS/DSH Desktop Fork",
    pnpmBinPath: platform === 'win32'
      ? 'C:\\Program Files\\DSH Desktop Fork\\resources\\app.asar.unpacked\\node_modules\\pnpm\\bin\\pnpm.mjs'
...
describe('desktop Host dsh runtime', () => {
  it('content-addresses Windows DSH shims and reuses an exact generation', () => {
    ...
    const runtimeOptions = {
      ...
      appExecutable: 'C:\\Program Files\\DSH Desktop Fork\\DSH Desktop Fork.exe',
      dshBootstrapPath: 'C:\\Program Files\\DSH Desktop Fork\\resources\\app.asar\\desktop-cli.js',
      profileName: 'web',
...
describe("RunAsNode scope", () => {
  it("never exports the flag from either Electron main process", () => {
    for (const variant of ["dsh-plugin-desktop-fork", "dsh-plugin-desktop-beta"]) {
