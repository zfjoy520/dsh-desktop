...
const seen = new Set()
const manifests = []
const queue = [{ name: rootManifest.name ?? 'dsh-plugin-desktop-fork', manifestPath: join(packageRoot, 'package.json') }]
...
if (noticesArg !== -1) {
  ...
  const lines = [
    '# Third-Party Notices',
    '',
    'DSH Desktop Fork distributes the following third-party packages inside its installers.',
