 ...
 *
 * The rule deliberately carries no `data-dsh-desktop-fork-mode` prefix: compatibility
...
const STYLE_ID = 'dsh-desktop-fork-sidebar-footer-styles'
...
export function installSidebarFooterStyles(): () => void {
  ...
  style.dataset.pluginCss = 'dsh-plugin-desktop-fork/sidebar-footer'
