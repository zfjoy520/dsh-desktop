...
/** Browser view of the Host `dsh-desktop-fork` settings namespace. */
...
/** Browser view of the Host `dsh-desktop-fork-notifications` settings namespace. */
...
export async function readDesktopSettingsUntilLanSettled(
  ...
  throw new Error('dsh-plugin-desktop-fork: unreachable LAN settings polling state')
}
...
export function DesktopSettingsSection({
    ...
    void run('material', async () => {
      if (platform === 'darwin') {
        if (next !== 'off' && next !== 'transparent') {
          throw new Error(`dsh-plugin-desktop-fork: invalid macOS material ${JSON.stringify(next)}`)
        }
        await desktopSettings.set('macosMaterial', next)
      } else if (platform === 'linux') {
        if (next !== 'off' && next !== 'transparent') {
          throw new Error(`dsh-plugin-desktop-fork: invalid Linux material ${JSON.stringify(next)}`)
        }
        await desktopSettings.set('linuxMaterial', next)
      } else if (platform === 'win32') {
        if (next !== 'off' && (next !== 'mica' || !micaSupported)) {
          throw new Error(`dsh-plugin-desktop-fork: unavailable Windows material ${JSON.stringify(next)}`)
        }
  ...
  return (
    <div className="dshDesktopSettings">
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-profile-title">
        <div>
          <h3 id="dsh-desktop-fork-profile-title">{t('profileTitle')}</h3>
        ...
        {view !== undefined && (
          <>
            <div className="dshDesktopSettingsList" role="radiogroup" aria-labelledby="dsh-desktop-fork-profile-title">
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-market-title">
        <div>
          <h3 id="dsh-desktop-fork-market-title">{t('marketTitle')}</h3>
        ...
        {view !== undefined && (
          <div className="dshDesktopSettingsList" role="radiogroup" aria-labelledby="dsh-desktop-fork-market-title">
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-aa-title">
        <div>
          <h3 id="dsh-desktop-fork-aa-title">{t('aaTitle')}</h3>
        ...
        {view !== undefined && <div className="dshDesktopSettingsList" role="radiogroup" aria-labelledby="dsh-desktop-fork-aa-title">
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-presentation-title">
        <div>
          <h3 id="dsh-desktop-fork-presentation-title">{t('presentationTitle')}</h3>
        ...
        {capabilities?.windowModes !== false && <div className="dshDesktopSettingsList" role="radiogroup" aria-labelledby="dsh-desktop-fork-presentation-title">
          <Choice
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-web-title">
        <div>
          <h3 id="dsh-desktop-fork-web-title">{t('webTitle')}</h3>
      ...
      <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-notifications-title">
        <div>
          <h3 id="dsh-desktop-fork-notifications-title">{t('notificationsTitle')}</h3>
      ...
      {capabilities?.updates !== false && (
        <section className="dshDesktopSettingsGroup" aria-labelledby="dsh-desktop-fork-updates-title">
          <div>
            <h3 id="dsh-desktop-fork-updates-title">{t('updatesTitle')}</h3>
      ...
      {confirmLan && (
        <div className="dshDesktopSettingsDialogBackdrop" role="presentation">
          <div className="dshDesktopSettingsDialog" role="alertdialog" aria-modal="true" aria-labelledby="dsh-desktop-fork-lan-warning-title" aria-describedby="dsh-desktop-fork-lan-warning-body">
            <h3 id="dsh-desktop-fork-lan-warning-title">{t('lanWarningTitle')}</h3>
            <p id="dsh-desktop-fork-lan-warning-body">{t('lanWarningBody')}</p>
