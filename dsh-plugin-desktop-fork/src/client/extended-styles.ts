...
const STYLE_ID = 'dsh-desktop-fork-framed-styles'

const CSS = `
html:has(body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"])),
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"]) {
  width: 100%;
  height: 100%;
}
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"]) {
  --dsh-desktop-fork-frame-height: 0px;
  margin: 0;
  overflow: hidden;
  background: transparent !important;
}
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"]) #root {
...
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"])
  > [aria-modal="true"] {
  top: var(--dsh-desktop-fork-frame-height) !important;
  transform: translateZ(0);
}
body[data-dsh-desktop-fork-mode="extended"] .dshDesktopSidebarSurface {
  --dsw-specific-sidebar-fill: transparent;
  border-right-color: transparent;
  background: transparent !important;
}
body[data-dsh-desktop-fork-mode="extended"] .dshDesktopFrame {
  background: var(--dsh-desktop-fork-frame-fill);
}
body[data-dsh-desktop-fork-mode="extended"] .dshDesktopConversationSurface {
  box-sizing: border-box;
  overflow: hidden;
...
body[data-dsh-desktop-fork-mode="extended"] .dshDesktopDetailsSurface {
  box-sizing: border-box;
  border-top: 1px solid var(--dsw-alias-border-l1);
}
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"])
  [data-dsh-desktop-fork-content-viewport],
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"])
  [data-dsh-desktop-fork-frame="titlebar"] {
  isolation: isolate;
}
body:is([data-dsh-desktop-fork-mode="compatibility"], [data-dsh-desktop-fork-mode="extended"])[data-dsh-desktop-fork-material="off"] {
  --dsh-desktop-fork-frame-fill: var(--dsw-alias-bg-layer-1);
}
body[data-dsh-desktop-fork-mode="compatibility"]:not([data-dsh-desktop-fork-material="off"]) {
  --dsh-desktop-fork-frame-fill: color-mix(in srgb, var(--dsw-alias-bg-base) 54%, transparent);
}
body[data-dsh-desktop-fork-mode="extended"]:not([data-dsh-desktop-fork-material="off"]) {
  --dsh-desktop-fork-frame-fill: color-mix(in srgb, var(--dsw-alias-bg-base) 18%, transparent);
}
...
export function installExtendedStyles(): () => void {
  ...
  style.id = STYLE_ID
  style.dataset.plugin = 'dsh-plugin-desktop-fork'
  style.dataset.pluginCss = 'dsh-plugin-desktop-fork/framed-shell'
