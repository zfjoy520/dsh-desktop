...
body:is([data-dsh-desktop-fork-mode="extended"], [data-dsh-desktop-fork-mode="advanced"]) { margin: 0; background: transparent !important; }
...
body:is([data-dsh-desktop-fork-mode="extended"], [data-dsh-desktop-fork-mode="advanced"])[data-dsh-desktop-fork-material="off"] .dshDesktopSidebarSurface { --dsw-specific-sidebar-fill: var(--dsw-alias-bg-layer-1); background: var(--dsw-alias-bg-layer-1); }
...
export function installDesktopOwnedStyles(): () => void {
  ...
  style.dataset.pluginCss = 'dsh-plugin-desktop-fork/desktop-owned-layout'
