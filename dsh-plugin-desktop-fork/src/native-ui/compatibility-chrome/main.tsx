...
export function Chrome() {
  ...
  if (!state) return <header className="dshDesktopFrameTitlebar">DSH Desktop Fork {failed && <span role="alert">{copy.operationFailed}</span>}</header>
...
if (root === null) throw new Error('dsh-desktop-fork: missing chrome root')
