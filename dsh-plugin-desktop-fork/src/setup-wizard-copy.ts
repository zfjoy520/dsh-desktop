...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up DSH Desktop Fork',
    profile: 'Profile',
    welcomeTitle: 'Welcome to DSH Desktop Fork',
    ...
    communityMarketBody: 'The open market built into DSH Desktop Fork, including custom data sources.',
    ...
    startUsing: 'Start using DSH Desktop Fork',
  ...
  zh: {
    ...
    beta: 'Beta',
    title: '设置 DSH Desktop Fork',
    profile: 'Profile',
    welcomeTitle: '欢迎使用 DSH Desktop Fork',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'DSH Desktop Fork 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
