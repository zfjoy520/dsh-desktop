...
const BIN_NAME = 'dsh-plugin-desktop-fork'
const DESKTOP_NAMESPACE = 'dsh-desktop-fork'
const NOTIFICATIONS_NAMESPACE = 'dsh-desktop-fork-notifications'
...
function parseMode(value: unknown): DesktopSetupWizardMode {
  ...
  throw invalid('dsh-desktop-fork.mode must be compatibility, extended, or advanced')
}
...
function parseExposure(value: unknown): DesktopSetupWizardNetworkExposure {
  ...
  throw invalid('dsh-desktop-fork.networkExposure must be loopback or lan')
}
