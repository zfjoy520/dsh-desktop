...
export const COMPATIBILITY_CHROME_CHANNEL = 'dsh-desktop-fork:compatibility-chrome'
export const COMPATIBILITY_CHROME_STATE = 'dsh-desktop-fork:compatibility-chrome-state'
