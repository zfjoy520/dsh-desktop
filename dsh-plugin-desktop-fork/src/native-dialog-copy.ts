...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    hostStoppedInstructions: 'Open windows can no longer reach it, and no work is lost on disk. Restart DSH Desktop Fork to reconnect, or open DSH Terminal to inspect the logs first.',
    openTerminal: 'Open DSH Terminal',
    restart: 'Restart DSH Desktop Fork',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'DSH Desktop Fork Update Available',
    updateAvailableMessage: version => `DSH Desktop Fork ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside DSH Desktop Fork Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'DSH Desktop Fork Is Up to Date',
    ...
    updateDownloadedTitle: 'DSH Desktop Fork Update Downloaded',
    updateReady: version => `DSH Desktop Fork ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace DSH Desktop Fork in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart DSH Desktop Fork and run the installer now?',
    ...
    updateInstalled: version => `DSH Desktop Fork ${version} has been installed.`,
  ...
  zh: {
    ...
    hostStoppedInstructions: '已打开的窗口无法再与它通信，磁盘上的内容不会丢失。重启 DSH Desktop Fork 即可重新连接；也可以先打开 DSH 终端查看日志。',
    openTerminal: '打开 DSH 终端',
    restart: '重启 DSH Desktop Fork',
    dismiss: '关闭',
    updateAvailableTitle: 'DSH Desktop Fork 有可用更新',
    updateAvailableMessage: version => `DSH Desktop Fork ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？DSH Desktop Fork Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'DSH Desktop Fork 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: 'DSH Desktop Fork 更新已下载',
    updateReady: version => `DSH Desktop Fork ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 DSH Desktop Fork，然后重新打开。',
    windowsInstallQuestion: '现在重启 DSH Desktop Fork 并运行安装程序？',
    ...
    updateInstalled: version => `DSH Desktop Fork ${version} 已安装。`,
