/** Cordis Host plugin for scheduled and interactive DSH Desktop Fork updates. */
...
/** Validated scheduled update policy. Fork builds ship with polling off. */
...
export function apply(ctx: Context, config: Config): void {
  ...
  }, 'dsh-plugin-desktop-fork: update polling, confirmation, and installer handoff')
}
